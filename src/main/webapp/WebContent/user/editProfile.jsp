...
<div class="row">
	...
	<div class="col-md-2">
		<a href="#" title="更換大頭貼">
			<img class="img-circle" style="width: 100px" src="/resources/imgs/noname.jpg">
		</a>
		<h3>userAcount</h3>
	</div>
	<div class="col-md-6">
	...
	<form class="form-horizontal">
		...
		<div class="form-group">
  		...
  		<div class="form-group">
    		...
    		<div class="col-md-10" >
      			<input type="radio" value="Male" id="radioSex" name="sex" checked="checked"><span id="radioSex">男</span>
      			<input type="radio" value="Female" id="radioSex" name="sex"><span id="radioSex">女</span>
      			<input type="radio" value="Other" id="radioSex" name="sex"><span id="radioSex">其他</span>
    		</div>
  		</div>
  		<div class="form-group">
   		...
   		<div class="form-group">
    		...
    		<div class="col-md-10">
      			<input type="text" class="form-control" id="inputReservedEmail" value="">
    		</div>
  		</div>
  		<div class="form-group">
